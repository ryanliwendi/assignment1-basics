...
from cs336_basics.train import cross_entropy, AdamW, learning_schedule
...
def run_multihead_self_attention(
    ...
    """
    multihead_attention_layer = MultiheadSelfAttention(d_model, num_heads)
    state_dict = {'W_Q.W': q_proj_weight.T, 'W_K.W': k_proj_weight.T, 'W_V.W': v_proj_weight.T, 'W_O.W': o_proj_weight.T}
...
def run_multihead_self_attention_with_rope(
    ...
    multihead_attention_layer = MultiheadSelfAttention(d_model, num_heads, rope_layer)
    state_dict = {'W_Q.W': q_proj_weight.T, 'W_K.W': k_proj_weight.T, 'W_V.W': v_proj_weight.T, 'W_O.W': o_proj_weight.T}
    multihead_attention_layer.load_state_dict(state_dict)
    return multihead_attention_layer(in_features, token_positions)
